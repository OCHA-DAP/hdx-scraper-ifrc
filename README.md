# Collector for IFRC Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-ifrc/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-ifrc/actions/workflows/run-python-tests.yaml)
[![Coverage Status](https://coveralls.io/repos/github/OCHA-DAP/hdx-scraper-ifrc/badge.svg?branch=main&ts=1)](https://coveralls.io/github/OCHA-DAP/hdx-scraper-ifrc?branch=main)
 ...
 **hdx-scraper-ifrc** as specified in the parameter
 *user_agent_lookup*.
